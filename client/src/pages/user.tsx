      ...
      {currentUser && currentUser.id !== user.id && (
        <div className="mb-5 flex flex-col gap-2">
          ...
          <div className="flex w-full gap-2">
            ...
            {isFavorite ? (
              <Button variant="secondary" size="icon" onClick={handleUnfavorite}>
                <Star fill="gold" />
              </Button>
            ) : (
            ...
            {isBlocked ? (
              <Button variant="destructive" size="icon" onClick={handleUnblock}>
                <ShieldOff />
              </Button>
            ) : (
              <Button variant="destructive" size="icon" onClick={handleBlock}>
                <ShieldOff />
              </Button>
            )}
          </div>
