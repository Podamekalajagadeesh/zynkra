    ...
    <PageShell title="Communities" description="Reddit-style forum discussions">
      <div className="grid grid-cols-[3fr_5fr_13fr] gap-6 h-full">
        ...
        <div className="flex-1 overflow-auto">
          {selectedCommunity ? (
            // Professional communities have their own dedicated view
            ...
            // If a channel is selected, render the appropriate channel view for non-professional communities
            selectedChannel ? (
              selectedChannel.type === 'voice' ? (
                ...
                // Text channel view - show thread list in text channels
                <div>
              ...
              // If no channel is selected but a thread is, show thread detail
              selectedThread ? (
                <ThreadDetail
                ...
                // Default community view - show thread list
                <div>
                  <div className="flex justify-between items-center mb-6">
