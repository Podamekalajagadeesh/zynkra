...
export type LanguagePreference = 'system' | 'en' | 'es' | 'fr' | 'de' | 'pt' | 'ja' | 'hi' | 'ar' | 'he' | 'zh' | 'ru' | 'sw' | 'tr' | 'ur' | 'vi';
...
export const LANGUAGE_OPTIONS: Array<{ value: LanguagePreference; label: string; description: string }> = [
  ...
  { value: 'hi', label: 'हिन्दी', description: 'Hindi language formatting.' },
  { value: 'ar', label: 'العربية', description: 'Arabic RTL layout support.' },
  { value: 'he', label: 'עברית', description: 'Hebrew RTL layout support.' },
  { value: 'zh', label: '中文', description: 'Chinese language formatting.' },
  { value: 'ru', label: 'Русский', description: 'Russian language formatting.' },
  { value: 'sw', label: 'Kiswahili', description: 'Swahili language formatting.' },
  { value: 'tr', label: 'Türkçe', description: 'Turkish language formatting.' },
  { value: 'ur', label: 'اردو', description: 'Urdu RTL layout support.' },
  { value: 'vi', label: 'Tiếng Việt', description: 'Vietnamese language formatting.' },
];
