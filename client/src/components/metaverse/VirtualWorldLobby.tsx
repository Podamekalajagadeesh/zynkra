                ...
                <div className="relative h-48 bg-gray-200 dark:bg-gray-800">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="flex items-center gap-2 text-white mb-2">
                      ...
                      {space.isVerified && (
                        <span className="ml-auto bg-green-500 text-white text-xs px-2 py-1 rounded-full flex items-center gap-1">
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center gap-1 text-sm text-gray-500">
                      ...
                      <span>{space.totalLandParcels} parcels</span>
                    </div>
                  </div>
                  <Button
                    className="w-full"
                    onClick={() => handleJoinWorld(space)}
                    disabled={isJoining && selectedWorld?.id === space.id}
                  >
                    {isJoining && selectedWorld?.id === space.id ? 'Joining...' : 'Enter Space'}
                  </Button>
                </div>
              </Card>
            ))}
