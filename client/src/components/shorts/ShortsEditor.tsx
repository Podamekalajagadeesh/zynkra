  ...
  const translateCaptions = async () => {
    ...
    try {
      ...
      const translationMocks: Record<string, Record<string, string>> = {
        ...
        de: {
          "This": "Dies", "is": "ist", "an": "ein", "automatically": "automatisch", "generated": "generierter", "caption": "Untertitel", "for": "für", "your": "Ihr", "video.": "Video.", "It": "Es", "uses": "verwendet", "advanced": "fortschrittliche", "speech": "Sprach", "recognition": "erkennung", "to": "um", "transcribe": "Ihren", "your": "Inhalt", "content": "in", "in": "real-time.": "Echtzeit zu transkribieren."
        },
        zh: {
