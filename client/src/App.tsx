...
import { getPosts, getForYouFeed, getFavoritesFeed, getFriendsFeed, getSubscriptionsFeed, setAuthToken, getFollowSuggestions, followUser } from './lib/api';
import { PostList } from './components/post-list';
import { useDarkMode } from './hooks/useDarkMode';
import { Button } from './components/ui/button';
import { MessageSquare, User, LogOut, LogIn, Menu, X, Sun, Moon, Users, Video, Zap, MoreHorizontal, Calendar, Clock, Heart, HandHeart, CalendarDays, Building2, Megaphone, UserPlus, Settings, MapPin, Compass, ArrowUpDown, Globe, Bot } from 'lucide-react';
...
const FollowRequestsPage = lazy(() => import('./pages/follow-requests').then((module) => ({ default: module.default })));
...
const ConnectedAccountsPage = lazy(() => import('./pages/ConnectedAccountsPage').then((module) => ({ default: module.ConnectedAccountsPage })));



const FormBuilder = lazy(() => import('./components/forms/FormBuilder').then((module) => ({ default: module.FormBuilder })));
const InstantForm = lazy(() => import('./pages/forms/InstantForm').then((module) => ({ default: module.InstantForm })));
const SubmissionsViewer = lazy(() => import('./components/forms/SubmissionsViewer').then((module) => ({ default: module.SubmissionsViewer })));
...
const AdsManagerPage = lazy(() => import('./pages/ads/AdsManagerPage').then((module) => ({ default: module.default })));
...
const CreateAdSetPage = lazy(() => import('./pages/ads/CreateAdSetPage').then((module) => ({ default: module.default })));
...
const CollectionPage = lazy(() => import('./pages/collection').then((module) => ({ default: module.default })));
...
const TimelineReview = lazy(() => import('./components/TimelineReview').then((module) => ({ default: module.default })));
...
const BoostPostPage = lazy(() => import('./pages/BoostPostPage').then((module) => ({ default: module.default })));
const BoostPostModal = lazy(() => import('./components/BoostPost/BoostPostModal').then((module) => ({ default: module.default })));
const ProfileReviewPage = lazy(() => import('./pages/profile-review').then((module) => ({ default: module.ProfileReviewPage })));
const NonprofitPage = lazy(() => import('./pages/NonprofitPage').then((module) => ({ default: module.default })));
const ApplyForNonprofitPage = lazy(() => import('./pages/nonprofits/apply').then((module) => ({ default: module.default })));
...
const MetaversePage = lazy(() => import('./pages/metaverse').then((module) => ({ default: module.default })));
...
function App() {
  const { isLoggedIn, activeAccount, isLoading } = useAuth();
  ...
  const { keys, generateKeys, saveKeys, hasKeys } = useKeys(activeAccount?.user);
    ...
    async function fetchPosts() {
      try {
        ...
        if (feedType === 'for-you') {
          ...
          fetchedPosts = await getFavoritesFeed();
        } else if (feedType === 'subscriptions') {
          fetchedPosts = await getSubscriptionsFeed();
        } else {
          fetchedPosts = await getFriendsFeed();
        }
