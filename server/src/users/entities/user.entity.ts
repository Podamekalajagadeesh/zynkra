...
export class User {
  ...
  @OneToMany(() => import('../../liveshopping/entities/live-shopping-event.entity').LiveShoppingEvent, (event) => event.host)
  liveShoppingEvents: import('../../liveshopping/entities/live-shopping-event.entity').LiveShoppingEvent[];
