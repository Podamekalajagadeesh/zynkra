...
export class UsersController {
  ...
  @UseGuards(JwtAuthGuard)
  @Post('block/keywords/:keyword')
  @HttpCode(HttpStatus.NO_CONTENT)
  async blockKeyword(@Request() req, @Param('keyword') keyword: string): Promise<void> {
    return this.usersService.blockKeyword(req.user.userId, keyword);
  }

  @UseGuards(JwtAuthGuard)
  @Delete('block/keywords/:keyword')
  @HttpCode(HttpStatus.NO_CONTENT)
  async unblockKeyword(@Request() req, @Param('keyword') keyword: string): Promise<void> {
    return this.usersService.unblockKeyword(req.user.userId, keyword);
  }
  ...
  @UseGuards(JwtAuthGuard)
  @Post('block/hashtags/:hashtag')
  @HttpCode(HttpStatus.NO_CONTENT)
  async blockHashtag(@Request() req, @Param('hashtag') hashtag: string): Promise<void> {
    return this.usersService.blockHashtag(req.user.userId, hashtag);
  }

  @UseGuards(JwtAuthGuard)
  @Delete('block/hashtags/:hashtag')
  @HttpCode(HttpStatus.NO_CONTENT)
  async unblockHashtag(@Request() req, @Param('hashtag') hashtag: string): Promise<void> {
    return this.usersService.unblockHashtag(req.user.userId, hashtag);
  }
