...
export class PodcastsCoursesNewsletters1785900100000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE TABLE "podcasts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "slug" character varying NOT NULL, "title" character varying(500) NOT NULL, "description" text NOT NULL, "coverImage" character varying, "audioUrl" character varying, "durationSeconds" integer NOT NULL DEFAULT 0, "authorId" uuid, "status" character varying NOT NULL DEFAULT 'draft', "tags" character varying[], "playCount" integer NOT NULL DEFAULT 0, "likeCount" integer NOT NULL DEFAULT 0, "commentCount" integer NOT NULL DEFAULT 0, "isGated" boolean NOT NULL DEFAULT false, "tokenPrice" numeric(10,2), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_podcasts_id" PRIMARY KEY ("id"), CONSTRAINT "UQ_podcasts_slug" UNIQUE ("slug"), CONSTRAINT "FK_podcasts_authorId" FOREIGN KEY ("authorId") REFERENCES "users"("id") ON DELETE CASCADE)
    `);
