...
export class CommerceEscrowReviews1785900200000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE TABLE "product_reviews" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "productId" uuid NOT NULL, "reviewerId" uuid NOT NULL, "rating" integer NOT NULL, "title" character varying NOT NULL, "content" text, "images" character varying[], "verifiedPurchase" boolean NOT NULL DEFAULT false, "helpfulCount" integer NOT NULL DEFAULT 0, "isHidden" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_product_reviews_id" PRIMARY KEY ("id"), CONSTRAINT "FK_product_reviews_productId" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE CASCADE, CONSTRAINT "FK_product_reviews_reviewerId" FOREIGN KEY ("reviewerId") REFERENCES "users"("id") ON DELETE CASCADE)
    `);
